                    ...
                    <div className="text-center mb-3">
                        {success && !error && (
                            <div
                                ...
                                <span className="block sm:inline">Votre demande a été envoyée avec succès.</span>
                        ...
                        {!success && error && (
                            <div className="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative"
                                ...
                                <span className="block sm:inline">Une erreur s&apos;est produite lors de l&apos;envoi de votre demande.</span>
