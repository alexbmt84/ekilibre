        ...
        <section id={"formations"}
            ...
            <div
                ...
                <div className="space-y-3 w-full">
                    ...
                    <p className={"max-w-[700px] mx-auto text-gray-500 text-justify tracking-wide font-body md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed"}>
                        Les formations 
                        <span className={"font-bold text-[#5DB3B6]"}> Ekilibre Parents Piscine </span>se déroulent où vous le souhaitez : à domicile dans votre propre piscine, chez un proche, dans un lieu privé équipé ou sur l&apos;un de nos sites partenaires, toujours précédées d&apos;une checklist de sécurité.
                    </p>
                    ...
                    <p className={"max-w-[700px] mx-auto text-gray-500 text-justify tracking-wide font-body md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed"}>
                        À l&apos;issue de la session, vous recevez un certificat <span className={"font-bold text-[#5DB3B6]"}>Ekilibre Parents Piscine</span>, un protocole familial personnalisé, la fiche “10 réflexes sécurité piscine”, ainsi que l&apos;ensemble des supports pédagogiques. Une option complémentaire permet également d&apos;obtenir le diplôme <span className={"font-bold text-[#5DB3B6]"}>PSC1</span>.
                    </p>
